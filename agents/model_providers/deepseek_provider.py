...
logger = logging.getLogger("inkoctobot.agents.model_providers.deepseek")
_DEFAULT_BASE = "https://api.deepseek.com"
_PRICING = {"deepseek-chat": (0.00014, 0.00028), "deepseek-reasoner": (0.00055, 0.0022)}
...
class DeepSeekProvider(BaseLLMProvider):
    ...
    def estimate_cost(self, input_tokens: int, output_tokens: int) -> float:
        p = _PRICING.get(self.config.model_name or "deepseek-chat", (0.00014, 0.00028))
        return (input_tokens / 1000 * p[0]) + (output_tokens / 1000 * p[1])
