...
README §2.6.1: System state changes publish Events, agents register
triggers that fire when conditions are met.
"""
...
logger = logging.getLogger("inkoctobot.agents.events.event_bus")
