...
Migrated from agents/constraints/violation_detector.py (non-LLM, vector-based).
"""
...
logger = logging.getLogger("inkoctobot.constraints.violation_detector")
            ...
            for result in results:
                ...
                if dist < self._threshold:
                    violations.append({
                        ...
                        "is_bad_example": result.get("metadata", {}).get(
