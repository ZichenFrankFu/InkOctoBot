...
All delta models are frozen for immutability. TruthDeltas is the top-level
bundle applied atomically by TruthFileStore.apply_deltas.
"""
...
# ──────────────────────────────────────────────────────────────
# 7. character_matrix — pairwise relationships (A→B view)
# ──────────────────────────────────────────────────────────────
...
class RelationUpdate(BaseModel):
    ...
    character_a: str
    character_b: str
    relation_type: str   # 师徒/兄弟/敌对/情侣/陌生/盟友/...
...
class TruthDeltas(BaseModel):
    ...
    character_relation_updates: list[RelationUpdate] = Field(default_factory=list)
...
class ApplyResult(BaseModel):
    """Outcome of TruthFileStore.apply_deltas."""
    success: bool
    chapter_num: int
