...
``StorylandStateStore.list_open_hooks`` or ``ReaderMemoryManager.get_unresolved_foreshadowing``
...
logger = logging.getLogger("inkoctobot.knowledge.reader_memory.episodic_timeline")
...
class EpisodicTimeline:
    ...
    # docs/SCHEMA_REDESIGN.md. Read pending_hooks via StorylandStateStore
    # or ReaderMemoryManager.get_unresolved_foreshadowing instead.
    ...
    def get_event_stats(self, project_id: str) -> dict[str, Any]:
        with self._conn() as c:
            ...
            # Foreshadowing count moved to StorylandStateStore.list_open_hooks.
            try:
