...
_SEED_FILE = Path(__file__).resolve().parent.parent / "resources" / "name_library" / "seed_names.txt"
...
def _ensure(con: sqlite3.Connection) -> None:
    from .schema import ensure_name_tables as ensure_market_extractor_tables
