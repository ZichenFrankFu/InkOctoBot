...
const NAV: NavGroup[] = [
  ...
  { title: "系统", items: [{ id: "settings", icon: "⚙️", label: "设置" }] },
];
  ...
  return (
    <div style={{ display: "flex", height: "100vh", width: "100vw", overflow: "hidden" }}>
      ...
      >
        <div
          onClick={() => {
            if (!sidebar.isDragging) setCollapsed(!collapsed);
          }}
          style={{
      ...
      <main style={{ flex: 1, overflow: "auto", background: "var(--bg-app)", minWidth: 0 }}>
        <div style={{ maxWidth: 1440, margin: "0 auto", padding: "28px 36px" }}>{page}</div>
      </main>
    </div>
  );
}
