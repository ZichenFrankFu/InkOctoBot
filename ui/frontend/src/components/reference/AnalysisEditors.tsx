...
export function PromptCopyPanel({
  ...
  refId: string;
  promptKey: "reference.characters" | "reference.settings" | "reference.outline" | "reference.style" | "reference.unified" | "reference.pure_setting" | "reference.pure_setting_translate";
