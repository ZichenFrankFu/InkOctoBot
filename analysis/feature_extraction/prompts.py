...
{platform_directive}{style_calibration}{chapter_outline}{time_location}{characters_block}{character_cards}{worldbook}{reference_summary}{referenced_materials}{writing_knowledge}{foreshadowing}{user_preferences}{existing_content}{skills_block}
...
4. 直接输出小说正文，不要输出标题、解释、大纲或任何格式标记。""",
        "vars": [
            "platform_directive", "style_calibration", "chapter_outline",
            "time_location", "characters_block", "character_cards", "worldbook",
            "reference_summary", "referenced_materials", "writing_knowledge",
            "foreshadowing", "user_preferences", "existing_content", "skills_block",
        ],
