...
_PIPELINE_ACTOR_PROSE = (
    "矿洞深处传来的低沉嗡鸣让李星河下意识地停住了脚步。\n\n"
    "\"怎么了？\"苏晚注意到他的异样，手已经摸上了腰间的粒子枪。"
    "她的动作如此自然流畅，像是呼吸一样。\n\n"
    "\"你听到了吗？\"李星河侧着头，竖起耳朵。"
    "那声音很低，低到几乎和矿星自转产生的地质噪音混在一起。"
    "但他的直觉告诉他，这不是自然现象——那个频率，太规律了。\n\n"
    "苏晚闭上眼睛，集中注意力听了几秒，然后摇了摇头："
    "\"我什么都没听到。但如果你说有，那就有。\"她的语气意外地认真，"
    "没有一丝质疑。\n\n"
    "李星河有些意外。自从两天前被迫组队以来，"
    "这位联邦特工一直对他保持着职业性的冷淡。这还是她第一次毫无保留地相信他的判断。\n\n"
    "\"在前面，大约三百米。\"他指着矿洞深处的黑暗，"
    "\"那个方向，和昨天水晶给我看到的星门图像……方位一致。\"\n\n"
    "苏晚的眼神变了。她没有说话，只是打开了战术头盔的红外模式，"
    "然后一言不发地走在了前面。\n\n"
    "李星河看着她的背影，心里忽然涌起一种奇怪的感觉——"
...
def _pick_response(messages: list[LLMMessage]) -> str:
    ...
    # Editor rewrite
    if any(kw in combined for kw in ["润色", "重写", "rewrite", "修改", "改写"]):
    ...
    if any(kw in combined for kw in ["演绎", "actor", "对话", "prose", "正文"]):
