...
{platform_directive}{market_overview}{user_special_requirements}{chapter_outline}{time_location}{characters_block}{character_cards}{worldbook}{reference}{referenced_materials}{storyland_state}{reader_memory}{foreshadowing}{subplots}{inspiration}{user_preferences}{existing_content}{current_chapter_draft}{skills}
...
4. 直接输出小说正文，不要输出标题、解释、大纲或任何格式标记。""",
        "vars": [
            "platform_directive", "market_overview",
            ...
            "storyland_state", "reader_memory",
            "foreshadowing", "subplots", "inspiration",
            "user_preferences", "existing_content",
            "current_chapter_draft", "skills",
        ],
        "description": "单 Agent / 快速生成正文的提示模板（含 LOADER_SPEC v3.1 全部 15 个 spec block 槽位）",
    },
